...
public class Screen extends Canvas implements Runnable
{
    ...
    public void tick()
    {
        ...
        for(int i = 0; i < objectCounter; i++)
        {
            CoreObject object = (Block) coreObjects[i];
            object.tick();
        }
        ball.tick();
    }
    ...
    public void reset()
    {
        ...
        paddle = new Paddle(Reference.CENTER_X - 25, Reference.HEIGHT - 30, 75, 15, Color.cyan);
        leftWall = new Wall(0 - 30, 0, 30, Reference.HEIGHT, Color.BLACK);
        rightWall = new Wall(Reference.WIDTH -5, 0, 30, Reference.HEIGHT, Color.BLACK);
        ball.setVelY(2);
        ball.setVelX(2);
        ...
        for(int i = 0; i < 14; i++)
        {
            ...
            coreObjects[i] = new Block(x - 18, y,40,20, Color.ORANGE);
            objectCounter++;
            x += 45;
        }
    }
